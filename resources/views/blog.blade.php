...
<main class="pt-8 pb-16 lg:pt-16 lg:pb-24 bg-white  antialiased">
            ...
            <header class="mb-4 lg:mb-6 not-format">
                <address class="flex items-center mb-6 not-italic">
                    <div class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                        ...
                        <div>
                            <a href="#" rel="author" class="text-xl font-bold text-gray-900 dark:text-black">Jese Leos</a>
  ...
  &lt;/dl&gt;
            ...
            <section class="not-format">
                ...
                <article class="p-6 mb-6 text-base bg-white rounded-lg dark:bg-white-900">
                    <footer class="flex justify-between items-center mb-2">
                        <div class="flex items-center">
                            ...
                            <p class="text-sm text-black-600 dark:text-black-400"><time pubdate datetime="2022-02-08"
